...
public final static String CONTEST_NAME="contestname";
 ...
 //   public final static String BASE_URL ="http://localhost:8080/webApp_Web%20exploded2/";
public final static String BASE_URL="http://localhost:8080/webApp_Web";
    public final static String CONTEST_ROOM_FXML_RESOURCE_LOCATION = "/MainScreensUBoat/contestPage.fxml";
