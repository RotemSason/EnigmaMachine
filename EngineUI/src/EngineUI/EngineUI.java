...
public final class EngineUI {
    ...
    private final MachineDictionary Dictionary;

    public EngineUI(List<Reflector> lstOfReflector,int UseRotors,List<Rotor> lstOfRotors,Keyboard Keyboard,CurrCode Code,int CommandCount,MachineDictionary Dictionary){
    ...
    public String getKeyboardABC(){return Keyboard.getABC();}
